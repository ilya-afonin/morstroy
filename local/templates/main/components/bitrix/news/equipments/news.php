...
<section class="equipment__content">
  <div class="container">
    ...
    <h1 class="title title_section">
      <?$APPLICATION->IncludeFile(SITE_TEMPLATE_PATH . "/include_areas/" . LANGUAGE_ID . "/equipment_title.php", Array(), Array("MODE" => "html", "NAME" => 'заголовок'))?>
    </h1>
    ...
    <script data-skip-moving="true">
        ...
        let component_arParams = <?echo CUtil::PhpToJSObject($arParams)?>;
    ...
    <? $APPLICATION->IncludeComponent(
        ...
        Array(
            ...
            "DETAIL_URL" => $arParams["FOLDER_URL_TEMPLATES_element"],
            "SECTION_URL" => $arParams["FOLDER_URL_TEMPLATES_section"],
            "IBLOCK_URL" => $arParams["FOLDER_URL_TEMPLATES_news"],
